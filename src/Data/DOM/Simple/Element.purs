...
setAttributes :: forall eff a. Element a ->
                               Array (T.Tuple String String) ->
                               a ->
                               (Eff (dom :: DOM | eff) Unit)
setAttributes (Element a { setAttribute = f }) = setMany f

setStyleAttrs :: forall eff a. Element a ->
                               Array (T.Tuple String String) ->
                               a ->
                               (Eff (dom :: DOM | eff) Unit)
setStyleAttrs (Element a { setStyleAttr = f }) = setMany f

setMany :: forall eff a. (String -> String -> a -> (Eff (dom :: DOM | eff) Unit)) ->
                         Array (T.Tuple String String) ->
                         a ->
                         (Eff (dom :: DOM | eff) Unit)
